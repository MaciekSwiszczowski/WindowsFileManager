...
|------------------------------------- |---------- |-----------:|---------:|----------:|------------------------:|-------------------:|-----------:|
| **InspectorThumbnailDiagnosticsHandler** | **5**         |   **423.7 ms** | **265.5 ms** |  **68.95 ms** |                       **-** |                  **-** |  **300.54 KB** |
| **InspectorThumbnailDiagnosticsHandler** | **20**        | **1,052.0 ms** | **712.1 ms** | **184.94 ms** |                       **-** |                  **-** | **1181.13 KB** |
