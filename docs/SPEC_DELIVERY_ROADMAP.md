...
- Spec 3 gates spec 4 only for the in-cell rename surface. The shortcut-registry refactor inside spec 4 can begin independently.
- Spec 6 (CsWin32 expansion) gates spec 7's `RegNotifyChangeKeyValue` usage.
- Spec 8 (features) does not gate anything — treat it as open-ended backlog.
