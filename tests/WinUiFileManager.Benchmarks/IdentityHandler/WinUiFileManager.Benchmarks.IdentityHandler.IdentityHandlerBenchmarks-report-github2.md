...
|------------------------------------ |---------- |-----------:|---------:|---------:|------------------------:|-------------------:|-----------:|
| **InspectorIdentityDiagnosticsHandler** | **100**       |   **158.8 ms** | **174.8 ms** | **45.40 ms** |                       **-** |                  **-** |  **419.72 KB** |
| **InspectorIdentityDiagnosticsHandler** | **500**       | **1,025.1 ms** | **249.6 ms** | **64.82 ms** |                       **-** |                  **-** | **2062.69 KB** |
